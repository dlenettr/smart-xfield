...
$module = array(
	'name'	=> "MWS Smart Xfield v1.3",
	'desc'	=> "İlave alanlarınız için koşullar",
	'id'	=> "",
	'icon'	=> "",
	'ticon' => "tags",
	'date'	=> "14.04.2015",
	...
	'image'	=> "http://img.dle.net.tr/mws/smart_xfield.png",
...
if ( $_REQUEST['action'] == "install" ) {
	...
	$mod->file( ROOT_DIR. "/install/xml/smart_xfield13.xml" );
	$mod->close();
